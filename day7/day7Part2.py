...
def solve(data) -> int:
  ...
  current_space = (device_total_space - calculate_directory_size(file_system))
  required_delete = required_space_for_update - current_space
  print(required_delete)
  get_sizes(file_system, sizes)
  possible_deletions = list(filter(lambda x: x > required_delete, sizes))
